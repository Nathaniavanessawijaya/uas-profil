    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-1">My Profile</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url();?>admin/pendidikan_page">
                    <i class="fas fa-user-graduate"></i>
                    <span>History Pendidikan</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url();?>admin/pengalaman_page">
                    <i class="fas fa-user-tie"></i>
                    <span>Pengalaman Kerja</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url();?>admin/kontak_page">
